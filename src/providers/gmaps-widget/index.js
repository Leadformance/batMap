...
import { MarkerClusterer } from '../gmaps/MarkerClustererPlus';

export default class GoogleMapsWidget extends AbstractMap {
  constructor(...args) {
    super(...args);
...
document.querySelector(
  '[data-reactroot]',
).contentWindow.GoogleMapWidget = GoogleMapsWidget;
document.querySelector(
  '[data-reactroot]',
).contentWindow.BatMap = GoogleMapsWidget;
